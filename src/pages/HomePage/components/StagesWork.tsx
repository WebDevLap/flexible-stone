  ...
  const stagesWorkItems: StagesWorkItemType[] = [
    {
      ...
      subtitle: <>Вы можете оставить <span onClick={(e) => {onOfferClick(); e.stopPropagation();}}>заявку</span> на сайте или позвонить по телефону <a href='tel:+79619751680'>+7 (961) 975 16-80</a></>,
    },
    {
